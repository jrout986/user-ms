...
import com.test.userms.bean.CustomException;

@ControllerAdvice
@RestController
public class DefaultExceptionConfiguration extends ResponseEntityExceptionHandler{
	
	@ExceptionHandler(Exception.class)
	public final ResponseEntity<Object> handleAllExceptions(Exception ex, WebRequest request) throws Exception {
			CustomException ce=new CustomException(new Date(), ex.getMessage(), request.getDescription(false));
		return new ResponseEntity<Object>(ce, HttpStatus.INTERNAL_SERVER_ERROR);
	}
